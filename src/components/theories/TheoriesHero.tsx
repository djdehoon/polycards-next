...
export function TheoriesHero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.05] p-8 text-center shadow-2xl shadow-black/50 backdrop-blur-md sm:p-12">
      <div
        className="theories-hero-shimmer pointer-events-none absolute inset-0 rounded-3xl opacity-35"
        aria-hidden
      />
      <div className="relative z-[1]">
        ...
        >
          ...
          <h1 className="mt-4 text-4xl font-bold leading-tight tracking-tight sm:text-5xl">
            <span className="bg-gradient-to-b from-white to-emerald-200/75 bg-clip-text text-transparent">
              Why PolyCards Works
            </span>
          </h1>
